...
class GetController{
	...
	public function getSearchData($table, $linkTo, $equalTo, $orderBy, $orderMode, $startAt, $endAt){

        $response = GetModel::getSearchData($table, $linkTo, $equalTo, $orderBy, $orderMode, $startAt, $endAt);
